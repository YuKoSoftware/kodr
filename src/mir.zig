...
const _mir_types = @import("mir_types.zig");
const _mir_registry = @import("mir_registry.zig");
const _mir_node = @import("mir_node.zig");

const RT = types.ResolvedType;

// ── Re-exports for backward compatibility ───────────────────
// All downstream consumers (codegen, main) import mir.zig — these re-exports
// keep their import paths unchanged.

pub const TypeClass = _mir_types.TypeClass;
pub const classifyType = _mir_types.classifyType;
pub const Coercion = _mir_types.Coercion;
pub const NodeInfo = _mir_types.NodeInfo;
pub const NodeMap = _mir_types.NodeMap;
pub const UnionRegistry = _mir_registry.UnionRegistry;
pub const MirNode = _mir_node.MirNode;
pub const LiteralKind = _mir_node.LiteralKind;
pub const MirKind = _mir_node.MirKind;
pub const IfNarrowing = _mir_node.IfNarrowing;
