...
- **Active project:** Phase 1 (Semantic Layer Cleanup) — S1 done (v0.53.2); S2 is next
...
> **⬅ RESUME HERE: S2** — S1 done (v0.53.2, 2026-04-20). Next: replace `DeclTable`'s 7 parallel StringHashMaps with a unified `Symbols` table.
