...
**~~B4. Bitfield → pure std module~~** — DONE
- Removed `bitfield` keyword and all compiler pipeline stages
- Replaced with `src/std/bitfield.zig` — pure Zig comptime function
