...
- **Active project:** Phase 2 (Diagnostics + Testing Overhaul) — T1 done (v0.53.7), T2 done (v0.53.8), T3 done (v0.53.10, 2026-04-25), T4 done (v0.53.11, 2026-04-25), T5 done (v0.53.12, 2026-04-25), T6 done (v0.53.13, 2026-04-25), T7 done (v0.53.14, 2026-04-25), T8a done (v0.53.15, 2026-04-25)
...
> **T8a complete** (v0.53.15, 2026-04-25). ⬅ **RESUME HERE: T8b** — Next: Sub-project 2b — Test runner rewrite.
